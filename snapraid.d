...
Configuration
  ...
  block_size SIZE_IN_KIBIBYTES
    ...
    rawsync
	Enables a single pass "sync" process avoding the initial hashing phase
	and saving time.
	In this mode no preliminary hashing is done, and the new data is hashed
	directly during the parity computation when it's read for the first time,
	...
	To avoid this problem, this "rawsync" mode is by default disabled,
	but if you really trust your hardware, you can enable it, and save time.
