...
const uint8_t  __attribute__((aligned(256))) gfmul[256][256] =
{
	{
...
const uint8_t __attribute__((aligned(256))) gfexp[256] =
{
...
const uint8_t __attribute__((aligned(256))) gfinv[256] =
{
 ...
 */
const uint8_t  __attribute__((aligned(256))) gfvandermonde[3][256] =
{
	{
 ...
 */
const uint8_t  __attribute__((aligned(256))) gfcauchy[6][256] =
{
	{
		0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
		0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
 ...
 */
const uint8_t  __attribute__((aligned(256))) gfcauchypshufb[251][4][2][16] =
{
	{
		{
 ...
 */
const uint8_t  __attribute__((aligned(256))) gfmulpshufb[256][2][16] =
{
	{
