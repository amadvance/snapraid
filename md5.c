 ...
 * of bytes.
 */
void md5_update(struct md5_t* ctx, const unsigned char* buf, unsigned len)
{
	uint32_t t;
 ...
 */
void md5_final(struct md5_t* ctx, unsigned char* digest)
{
 ...
 */
void MD5(uint8_t *buffer, unsigned int length, uint8_t *digest)
{
	struct md5_t md5ctx;
	md5_init(&md5ctx);
