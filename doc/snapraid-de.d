...
Pattern
	Muster werden verwendet, um eine Teilmenge von Dateien zum
	Ausschließen oder Einschließen in den Prozess auszuwählen.

	Es gibt vier verschiedene Arten von Mustern:

	=FILE
		Wählt jede Datei namens DATEI aus. Sie können beliebige
		Globbing-Zeichen wie * und ? sowie Zeichenklassen wie [a-z]
		verwenden. Dieses Muster gilt nur für Dateien, nicht für
		Verzeichnisse.

	=DIR/
		Wählt jedes Verzeichnis namens VERZ und alles darin aus.
		Sie können beliebige Globbing-Zeichen wie * und ? verwenden.
		Dieses Muster gilt nur für Verzeichnisse, nicht für Dateien.

	=/PATH/FILE
		Wählt den exakt angegebenen Dateipfad aus. Sie können beliebige
		Globbing-Zeichen wie * und ? verwenden, aber sie stimmen niemals
		mit einem Verzeichnis-Slash überein.
		Dieses Muster gilt nur für Dateien, nicht für Verzeichnisse.

	=/PATH/DIR/
		Wählt den exakt angegebenen Verzeichnispfad und alles darin
		aus. Sie können beliebige Globbing-Zeichen wie * und ? verwenden,
		aber sie stimmen niemals mit einem Verzeichnis-Slash überein.
		Dieses Muster gilt nur für Verzeichnisse, nicht für Dateien.
