...
Команди (Commands)
  ...
  diff
	...
	зведення змін, згруповане за:
		...
		relocated (перерозміщені) - Файли, переміщені на той самий або інший диск, де
			оригінал зник.
			Вони ідентифікуються за однаковою назвою, розміром та міткою
			часу.
			Якщо мітка часу з точністю до часток секунди дорівнює нулю, для
			ідентифікації має збігатися повний шлях.
			На відміну від файлів 'moved' на тому ж диску, переміщені файли
			мають інший inode.
