...
Відомі проблеми (Known Issues)
  ...
  Зарезервовані імена файлів і каталогів
	SnapRAID резервує деякі імена файлів, каталогів і знімків для своїх
	внутрішніх операцій. Не використовуйте ці імена для даних користувача:

	.snapraidignore - Локальний файл правил виключення.
	.snapraid - Каталог-контейнер знімків.
	snapraid-* - Імена знімків ZFS, керованих SnapRAID.
	*.unrecoverable - Пошкоджені файли, поміщені в карантин під час
		відновлення.
	CONTENT.tmp - Тимчасовий файл для оновлень файлу content.
	CONTENT.lock - Файл блокування файлу content.
	PARITY.spaceholder - Тимчасовий файл резервування місця під час виділення
		парності у Windows.

	Використання цих імен для непов'язаних даних може призвести до того, що
	файли або знімки будуть проігноровані, помилково сприйняті як метадані,
	перезаписані, перейменовані або видалені.

	У Windows усі варіанти регістру також зарезервовані, навіть у каталогах
	NTFS, налаштованих з урахуванням регістру (наприклад, .SNAPRAIDIGNORE,
	.SnapRaid, CONTENT.TMP та CONTENT.Lock).
