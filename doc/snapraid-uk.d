  ...
  diff
	...
	зведення змін, згруповане за:
		...
		moved (переміщені) - Файли, переміщені в інший каталог
			...
			каталогом.
		copied - файли, скопійовані на той самий або інший диск, де
		...
		relocated - файли, переміщені на той самий або інший диск, де
			оригінал зник.
			Вони ідентифікуються за однаковою назвою, розміром та міткою
			часу.
			Якщо мітка часу з точністю до часток секунди дорівнює нулю, для
			...
			мають інший inode.
		restored - файли з іншим inode, але зі збігом каталогу, назви,
...
Опції (Options)
	...
	-W, --force-realloc-tail РОЗМІР
		Працює як -R, --force-realloc, але обмежується вказаною кінцевою
		частиною (останні РОЗМІР байт) кожного файлу парності.
		...
		про зачеплені файли.
		УВАГА!
		Цей параметр призначений лише для експертів, і його настійно
