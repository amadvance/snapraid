...
Відомі проблеми (Known Issues)
  ...
  Суфікс невідновлюваних файлів
	...
	І навпаки, якщо відновлюється відсутній файл і відповідний файл `.unrecoverable`
	вже існує, SnapRAID припускає, що це результат попереднього незавершеного
	відновлення, і відновлює запис безпосередньо в нього.
	...
	бути усічений, перезаписаний або замінений, якщо його базова назва збігається
	з файлом, що відновлюється.
