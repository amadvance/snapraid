...
Pattern
	Шаблоны используются для выбора подмножества файлов для исключения или включения
	в процесс.

	Существует четыре различных типа шаблонов:

	=FILE
		Выбирает любой файл с именем FILE. Вы можете использовать любые символы
		глоббинга, такие как * и ?, и классы символов, такие как [a-z].
		Этот шаблон применяется только к файлам, а не к каталогам.

	=DIR/
		Выбирает любой каталог с именем DIR и все внутри.
		Вы можете использовать любые символы глоббинга, такие как * и ?.
		Этот шаблон применяется только к каталогам, а не к файлам.

	=/PATH/FILE
		Выбирает точно указанный путь к файлу. Вы можете использовать любые
		символы глоббинга, такие как * и ?, но они никогда не совпадают с
		косой чертой каталога.
		Этот шаблон применяется только к файлам, а не к каталогам.

	=/PATH/DIR/
		Выбирает точно указанный путь к каталогу и все внутри.
		Вы можете использовать любые символы глоббинга, такие как * и ?, но
		они никогда не совпадают с косой чертой каталога.
		Этот шаблон применяется только к каталогам, а не к файлам.
