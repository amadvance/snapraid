...
Mönster
	Mönster används för att välja en delmängd av filer att exkludera eller inkludera i
	processen.

	Det finns fyra olika typer av mönster:

	=FIL
		Väljer alla filer som heter FIL. Du kan använda alla globbing-
		tecken som * och ?, och teckenklasser som [a-z].
		Detta mönster gäller endast för filer, inte kataloger.

	=KATALOG/
		Väljer alla kataloger som heter KATALOG och allt inuti.
		Du kan använda alla globbing-tecken som * och ?.
		Detta mönster gäller endast för kataloger, inte filer.

	=/SÖKVÄG/FIL
		Väljer den exakt specificerade filsökvägen. Du kan använda alla
		globbing-tecken som * och ?, men de matchar aldrig ett
		katalog-snedstreck.
		Detta mönster gäller endast för filer, inte kataloger.

	=/SÖKVÄG/KATALOG/
		Väljer den exakt specificerade katalogsökvägen och allt
		inuti. Du kan använda alla globbing-tecken som * och ?, men
		de matchar aldrig ett katalog-snedstreck.
		Detta mönster gäller endast för kataloger, inte filer.
