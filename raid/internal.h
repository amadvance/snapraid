 ...
 * Tables.
 */
extern const uint8_t raid_gfmul[256][256] __attribute__((aligned(256)));
extern const uint8_t raid_gfexp[256] __attribute__((aligned(256)));
extern const uint8_t raid_gfinv[256] __attribute__((aligned(256)));
extern const uint8_t raid_gfvandermonde[3][256] __attribute__((aligned(256)));
extern const uint8_t raid_gfcauchy[6][256] __attribute__((aligned(256)));
extern const uint8_t raid_gfcauchypshufb[251][4][2][16] __attribute__((aligned(256)));
extern const uint8_t raid_gfmulpshufb[256][2][16] __attribute__((aligned(256)));
